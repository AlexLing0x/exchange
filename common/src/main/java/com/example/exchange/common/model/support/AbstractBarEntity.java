package com.example.exchange.common.model.support;
...
public class AbstractBarEntity implements EntitySupport {
    ...
    public Number[] getBarData() {
        return new Number[]{this.startTime, this.openPrice, this.highPrice, this.lowPrice, this.closePrice, this.quantity};
    }
